...
/**
 * Class SubsetSumSeq is sequential program that checks if there exists any
 * subset for the set S or n objects from input file using dynamic 2D table.
 * <P>
 * Usage: <TT>java pj2 SubsetSumSeq <I><input_file></I> <I>[p]</I>
 * 
